...
Markdown is rendered natively. The welcome page uses this same viewer. Preview uses Foundation’s Markdown parser and TextKit, without a browser process. Files larger than 5 MB remain available in the source editor.
