...
struct AssociationPolicy {
    static let sourceExtensions:Set<String> = ["c","h","c++","h++","cc","cpp","cxx","hpp","hh","hxx","m","mm","swift","java","py","pyw","rb","rs","go","js","jsx","tsx","kt","kts","scala","sc","lua","sh","bash","zsh","fish","php","php3","php4","php5","phtml","pl","pm","f","f77","f90","f95","for","ada","adb","ads","pas","pp","inc","asm","s"]
    ...
    static let catalog:[String:[String]] = [
        ...
        "com.sun.java-source":["java"],"com.netscape.javascript-source":["js"],"public.php-script":["php","php3","php4","php5","phtml"]
    ]
    ...
    static func eligible(extensions:[String], isSource:Bool, current:String?) -> Bool {
        !extensions.isEmpty && Set(extensions.map{$0.lowercased()}).isSubset(of:sourceExtensions) && isSource && (current == nil || editors.contains(current!.lowercased()))
    }
}
